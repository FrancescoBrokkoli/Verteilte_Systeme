...
import dhbwka.wwi.vertsys.javaee.recordcollecta.common.web.WebUtils;
import dhbwka.wwi.vertsys.javaee.recordcollecta.common.web.FormValues;
...
import dhbwka.wwi.vertsys.javaee.recordcollecta.common.ejb.ValidationBean;
...
public class TaskEditServlet extends HttpServlet {
    ...
    private void saveTask(HttpServletRequest request, HttpServletResponse response)
        ...
        // Albumtitel
                String taskShortText2 = request.getParameter("task_short_text2");
        // Albumtitel   
        ...
        if (dueDate != null) {
            ...
            errors.add("Das Datum muss dem Format yyyy entsprechen.");
        }
      ...
      //  }
       ...
       try {
        ...
        //Albumtitel
        task.setShortText2(taskShortText2);
        //Albumtitel
    ...
    private FormValues createTaskForm(Task task) {
       ...
       values.put("task_due_time", new String[]{
        ...
        //Albumtitel
                values.put("task_short_text2", new String[]{
            task.getShortText2()
        });
        //Albumtitel
